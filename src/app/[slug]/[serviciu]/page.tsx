...
export default async function LocalServicePage({ params }: PageProps) {
 ...
 <p className="rounded-xl border oc-border bg-white p-4 oc-secondary-text">Fii primul salon din {orasName}</p>
 )}
 </section>

 <Link href="/signup?start=1" className="inline-flex rounded-lg oc-primary px-6 py-3 font-semibold text-white hover:oc-primary">
