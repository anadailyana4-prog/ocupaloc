-- Fix PR2: remove invalid transaction isolation statement inside PL/pgSQL function
-- Postgres error 25001 occurs when SET TRANSACTION is executed inside function context
