...
export const metadata: Metadata = {
  ...
  openGraph: {
    url: "https://ocupaloc.ro/software-programari-manichiura"
  }
};
      ...
      <div className="mx-auto max-w-5xl space-y-10">
        <section className="rounded-2xl border oc-border bg-white p-8">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link href="/signup?start=1" data-cta-location="seo_manichiura_hero_primary" className="rounded-lg oc-primary px-5 py-3 font-semibold text-white">
              Încearcă gratuit
            </Link>
            <Link href="/signup?start=1" data-cta-location="seo_manichiura_hero_secondary" className="rounded-lg border oc-border px-5 py-3 font-semibold oc-text hover:oc-badge-bg">
              Activează contul
            </Link>
          </div>
        </section>
