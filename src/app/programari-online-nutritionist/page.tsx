...
export default function ProgramariOnlineNutritionistPage() {
  const faqSchema = {
      ...
      <div className="mx-auto max-w-5xl space-y-14">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <article className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-zinc-400">
                ...
                <span className="font-mono text-zinc-300">ocupaloc.ro/numele-tau</span> — pui linkul în Instagram, TikTok, Google Business sau site.
              </p>
            </article>
            <article className="rounded-xl border border-zinc-800 bg-zinc-900 p-5">
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <article className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6">
              <h3 className="text-xl font-semibold text-indigo-300">Nutriționist independent cu program fix sau flexibil</h3>
              <p className="mt-3 leading-relaxed text-zinc-300">
            ...
            <article className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-6">
              <h3 className="text-xl font-semibold text-indigo-300">Nutriționist cu activitate predominant online</h3>
              <p className="mt-3 leading-relaxed text-zinc-300">
              ...
              <tbody>
                {competitorRows.map((row) => (
                  <tr key={row.feature} className="border-b border-zinc-800">
                    ...
                    <td className="py-3 text-zinc-400">{row.calendly}</td>
                  </tr>
                ))}
              </tbody>
            </table>
